        ...
        <div class="flex h-screen">
                ...
                <nav class="mt-2">
                    ...
                    <a href="#" data-target="users"
                       class="nav-item flex items-center p-4 text-gray-300 hover:bg-gray-800">
                        <i class="fa-solid fa-user-circle w-5 mr-3"></i> Users
                    </a>
            ...
            <div class="flex-1 overflow-auto">
                ...
                <header class="flex justify-between items-center p-4 bg-white shadow">
                    <h1 class="text-2xl font-bold text-dark" id="page-title">Dashboard</h1>
                ...
                <div id="dashboard" class="content-section active">
                        ...
                        <div class="bg-white rounded-lg shadow p-6 transition-transform hover:scale-105">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <h2 class="text-3xl font-bold">356</h2>
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 pb-6">
                                ...
                                <table class="w-full">
                                    ...
                                    <tbody>
                                        <tr class="border-b border-gray-100 text-sm hover:bg-gray-50">
                                            <td class="py-3">Harthik</td>
                                            <td class="py-3">12 Aug 2025</td>
                                            <td class="py-3">Rs. 3600.00</td>
                                            <td class="py-3"><span
                                                    class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Completed</span>
                                            </td>
                                        </tr>
                                        <tr class="border-b border-gray-100 text-sm hover:bg-gray-50">
                                            <td class="py-3">Banujan</td>
                                            <td class="py-3">13 Aug 2025</td>
                                            <td class="py-3">Rs. 750.00</td>
                                            <td class="py-3"><span
                                                    class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Completed</span>
                                            </td>
                                        </tr>
                        ...
                        <!-- Popular Books -->
                        <div class="bg-white rounded-lg shadow p-6">
                            <h2 class="text-xl font-bold mb-4">Popular Books</h2>
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-3 hover:bg-gray-50 rounded">
                                    <div class="flex items-center">
                                        <span class="text-lg font-bold text-primary mr-3">1</span>
                                        <img src="images/book/08.png" alt="Book"
                                             class="mr-3 rounded h-16 w-12">
                                        <div>
                                            <h3 class="font-medium">Einstein</h3>
                                            <p class="text-sm text-gray-500">James Sheriya</p>
                                        </div>
                                    </div>
                                    <span class="text-secondary font-medium">28 sales</span>
                                    <span class="font-mediumss">27 Stock</span>
                                </div>
                                <div class="flex items-center justify-between p-3 hover:bg-gray-50 rounded">
                                    <div class="flex items-center">
                                        <span class="text-lg font-bold text-primary mr-3">2</span>
                                        <img src="images/book/14.png" alt="Book"
                                             class="mr-3 rounded h-16 w-12">
                                        <div>
                                            <h3 class="font-medium">Elon Musk</h3>
                                            <p class="text-sm text-gray-500">Ashlee Vance</p>
                                        </div>
                                    </div>
                                    <span class="text-secondary font-medium">19 sales</span>
                                    <span class="font-medium">15 Stock</span>
                                </div>
                                <div class="flex items-center justify-between p-3 hover:bg-gray-50 rounded">
                                    <div class="flex items-center">
                                        <span class="text-lg font-bold text-primary mr-3">3</span>
                                        <img src="images/book/18.png" alt="Book"
                                             class="mr-3 rounded h-16 w-12">
                                        <div>
                                            <h3 class="font-medium">The Unwilling</h3>
                                            <p class="text-sm text-gray-500">John Hart</p>
                                        </div>
                                    </div>
                                    <span class="text-secondary font-medium">16 sales</span>
                                    <span class="font-medium">2 Stock</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="books" class="content-section p-4">
                    <%@ include file="../views/include/admin-book.jsp" %>
                </div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-2">
                            ...
                            <div class="lg:w-2/3">
                                <div class="bg-white rounded-xl shadow-lg p-6">
                                    <div class="flex justify-between items-center mb-2">
                                        <h2 class="text-2xl font-semibold text-gray-800">User Table</h2>
                                        ...
                                        <table class="book-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="py-4 px-5 text-left">Password</th>
                                                    <th class="py-3 px-4 text-right">Role</th>
                                            ...
                                            <tbody>
                                                <tr class="bg-gray-50">
                                                    <td class="py-3 px-4 border-t border-gray-200">User1</td>
                                                    <td class="py-3 px-4 border-t border-gray-200">********</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">user</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">user123@gmail.com</td>
                                                ...
                                                <tr class="bg-gray-50">
                                                    <td class="py-3 px-4 border-t border-gray-200">Cashier</td>
                                                    <td class="py-3 px-4 border-t border-gray-200">********</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">user</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">cashier@gmail.com</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-center">
                                                        <button class="action-btn text-blue-600 hover:text-blue-800 mr-2">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                ...
                                                <tr class="bg-gray-50">
                                                    <td class="py-3 px-4 border-t border-gray-200">Nilujan</td>
                                                    <td class="py-3 px-4 border-t border-gray-200">********</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">user</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-right">nilujan@gmail.com</td>
                                                    <td class="py-3 px-4 border-t border-gray-200 text-center">
                                                        <button class="action-btn text-blue-600 hover:text-blue-800 mr-2">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                            ...
                            <div class="lg:w-1/3 mt-8 lg:mt-0">
                                <div class="bg-white rounded-xl shadow-lg p-6 h-fit sticky top-6">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-2">Add New User</h2>
                                    ...
                                    <form id="bookForm" class="space-y-2">
                                        ...
                                        <div>
                                            <label for="author" class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                        ...
                        <form id="profileForm" class="max-w-2xl mx-auto">                          
                            <div>
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="username" class="w-full px-4 py-2 border rounded-lg focus:ring-primary focus:border-primary" value="admin">
                                </div>

                                <div class="mb-2">
                                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                    <input type="email" id="email" class="w-full px-4 py-2 border rounded-lg focus:ring-primary focus:border-primary" value="admin@gmail.com">
                                </div>
